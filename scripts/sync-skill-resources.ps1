...
if ($null -ne $manifestResource) {
    ...
    # PowerShell 5.1 and 7 use different pretty-print indentation. A compact
    # representation keeps generated bytes stable across both CI and local hosts.
    $manifestContent = ConvertTo-StableText (($manifest | ConvertTo-Json -Depth 5 -Compress) + "`n")
