...
description: Map and configure greenfield or brownfield repositories with the Core-First Agent Harness v3.
---

# Setup Agent Harness — Harness v3
...
3. After the static proposal is valid, run configured capability descriptors to collect a revision-bound dynamic baseline. Ask only when the command crosses a high-risk approval boundary.
4. Install `.harness/project.yaml`, a concise router, and `docs/index.md` before proposing moves. Baseline pre-existing debt by exact fingerprint and review date.
