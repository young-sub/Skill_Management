...
4. Install `.harness/project.yaml`, a concise router, and `docs/index.md` before proposing moves. Record pre-existing debt only when it would otherwise block relevant work.
