...
description: Report deterministic Harness v3 resource, mapping, and work-lifecycle integrity.
---
...
Audit instruction mirrors, direct `docs/index.md` links, unmapped impact surfaces, the exact installed cohort tree, typed work namespaces, transaction markers, and branch/worktree state. Optional brownfield baselines may suppress only exact unexpired findings; selector budgets and broad architecture analysis are not default maintenance gates.
