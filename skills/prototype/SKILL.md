...
3. Build only enough behavior and visual fidelity to answer the question. Keep basic input validation, failure feedback, and accessibility. Add a small runnable check for consequential logic or invalid transitions; do not build a comprehensive test suite for throwaway scaffolding.
