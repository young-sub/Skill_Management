...
description: Execute a default- or explicitly-authorized Core-First Harness v3 Item contract with impact-selected verification and policy-selected commits.
---
...
1. Verify default or explicit authorization against a freshly rendered canonical Review and fail closed on veto, contract/Review drift, unresolved decisions, unsupported version, mixed cohort, or incomplete legacy transaction.
