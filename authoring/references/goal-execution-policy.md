...
- Capture the current branch and commit and preserve the dirty baseline. Create branches and commits only when repository policy or the human requires them, using independently reviewable verified slices.
