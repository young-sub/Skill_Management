...
Normal capability work uses two to five canonical Items. A Korean Design Review shows What, How, Test, and Done with stable IDs and behavior visuals. Natural approval authorizes the bound contract; host Goal tracking is optional. Implement dependency-ready core Items first, run mapped Impacted checks, and commit each verified Item separately.
