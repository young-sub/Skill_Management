...
- `.harness/project.yaml` owns project mapping, impact, commands, retention, Git policy, and baseline debt.
- `docs/index.md` owns technical navigation; `docs/architecture/harness.md` owns Harness boundaries; `docs/testing.md` owns verification semantics.
