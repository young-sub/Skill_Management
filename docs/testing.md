...
Full runs only for a configured trigger: shared policy, schema, generated resources, test discovery, repository workflow cutover, or an explicit request. `not_required` names the matched impact rule; it never means passed.
